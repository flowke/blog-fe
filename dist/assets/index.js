	...
	var Index = function (_React$Component) {
	    ...
	    _createClass(Index, [{
	        ...
	        value: function render() {
	            var infoPanel = this.state.infoPanel;
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(_info2.default, { token: infoPanel })
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Info = function (_React$Component) {
	    ...
	    _createClass(Info, [{
	        ...
	        key: 'handleSignin',
	        value: function handleSignin(data) {
	            console.log(data);
	        }
	    }, {
	        key: 'render',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserEntry = function (_React$Component) {
	    ...
	    function UserEntry(props) {
	        ...
	        _this.canSubmit = [false, false, false];
	    ...
	    _createClass(UserEntry, [{
	        ...
	        value: function handleSubmit(ev) {
	            ...
	            var _props = this.props,
	                ...
	                handleSignin = _props.handleSignin;
	            var _state = this.state,
	                userVal = _state.userVal,
	                passwVal = _state.passwVal,
	                cfpasswVal = _state.cfpasswVal;
	
	            if (this.state.canSubmit) {
	                isLogin ? handleLogin({ userVal: userVal, passwVal: passwVal }) : handleSignin({ userVal: userVal, passwVal: passwVal, cfpasswVal: cfpasswVal });
	            }
	        }
	        ...
	        value: function validValue(token, ev) {
	            var _state2 = this.state,
	                userVal = _state2.userVal,
	                passwVal = _state2.passwVal,
	                cfpasswVal = _state2.cfpasswVal;
	
	            var boolArr = this.canSubmit;
	            var msg = '';
	            switch (token) {
	                case 'username':
	                    userVal = ev.target.value;
	                    this.setState({ userVal: userVal });
	                ...
	                case 'passw':
	                    ...
	                    this.setState({ passwVal: passwVal });
	                ...
	                case 'cfpassw':
	                    ...
	                    this.setState({ cfpasswVal: cfpasswVal });
	            ...
	            this.setState({
	                canSubmit: boolArr.every(function (elt) {
	                    return elt;
	                })
	            });
	        }
	        ...
	        value: function componentDidMount() {
	            this.validator.addByValue('username', [{ strategy: 'isEmpty', errorMsg: '用户名不能为空' }, { strategy: 'hasSpace', errorMsg: '不能有空格' }, { strategy: 'isNumberHead', errorMsg: '不能数字开头' }]);
	            this.validator.addByValue('passw', [{ strategy: 'isEmpty', errorMsg: '用户名不能为空' }, { strategy: 'hasSpace', errorMsg: '不能有空格' }]);
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            var _state3 = this.state,
	                forUser = _state3.forUser,
	                forPwssw = _state3.forPwssw,
	                forCfpwssw = _state3.forCfpwssw,
	                userVal = _state3.userVal,
	                passwVal = _state3.passwVal,
	                cfpasswVal = _state3.cfpasswVal;
	
	            var cfPassw = null;
	            if (!isLogin) {
	                cfPassw = React.createElement(
	                    'div',
	                    { className: 'form-group ' + forCfpwssw },
	                    React.createElement(
	                        'div',
